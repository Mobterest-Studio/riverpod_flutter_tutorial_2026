...
import 'order_status.dart' as _i8;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.OrderStatus) {
      return _i8.OrderStatus.fromJson(data) as T;
    }
    if (t == _i9.Product) {
    ...
    if (t == _i1.getType<_i8.OrderStatus?>()) {
      return (data != null ? _i8.OrderStatus.fromJson(data) : null) as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i6.Order => 'Order',
      _i7.OrderItem => 'OrderItem',
      _i8.OrderStatus => 'OrderStatus',
      _i9.Product => 'Product',
      _i10.User => 'User',
      _ => null,
    };
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'OrderStatus') {
      return deserialize<_i8.OrderStatus>(data['data']);
    }
  ...
  @override
  String getModuleName() => 'shopwave_backend';
